...
# Pell Newport Bridge location (Center of main span)
BRIDGE_LAT = 41.50511709580034
BRIDGE_LON = -71.34869677264777

# Pell Newport Bridge piers (GPS coordinates provided)
PELL_BRIDGE_PIERS = {
    'pier_1': {
        'name': 'Pier 1',
        'lat': 41.50715264541284,
        'lon': -71.35790126940176,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_2': {
        'name': 'Pier 2',
        'lat': 41.507038074063416,
        'lon': -71.35740118608581,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_3': {
        'name': 'Pier 3 (Anchorage)',
        'lat': 41.50677770654508,
        'lon': -71.35620957396857,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_4': {
        'name': 'Pier 4',
        'lat': 41.50651709062597,
        'lon': -71.35502976836909,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_5': {
        'name': 'Pier 5',
        'lat': 41.50625661321038,
        'lon': -71.35384996276961,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_6': {
        'name': 'Pier 6 (Tower)',
        'lat': 41.505746875126405,
        'lon': -71.351505342934,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_7': {
        'name': 'Pier 7 (Tower)',
        'lat': 41.504494729450776,
        'lon': -71.34591002388918,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 50
    },
    'pier_8': {
        'name': 'Pier 8',
        'lat': 41.50392344673417,
        'lon': -71.34351971064085,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_9': {
        'name': 'Pier 9',
        'lat': 41.5036804393384,
        'lon': -71.34243154455388,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_10': {
        'name': 'Pier 10 (Anchorage)',
        'lat': 41.50340346766361,
        'lon': -71.3412361026638,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_11': {
        'name': 'Pier 11',
        'lat': 41.503133903317796,
        'lon': -71.34006052388594,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_12': {
        'name': 'Pier 12',
        'lat': 41.50287165156453,
        'lon': -71.33896605638834,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_13': {
        'name': 'Pier 13',
        'lat': 41.50258934124054,
        'lon': -71.33771126267679,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_14': {
        'name': 'Pier 14',
        'lat': 41.50231927936634,
        'lon': -71.33659836079121,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_15': {
        'name': 'Pier 15',
        'lat': 41.5021389004851,
        'lon': -71.33577109752362,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    },
    'pier_16': {
        'name': 'Pier 16',
        'lat': 41.501500405064775,
        'lon': -71.33300004834254,
        'lateral_capacity_kips': 5000,
        'water_depth_ft': 35
    }
}
...
def analyze_vessel(ship_data):
    ...
    pier = PELL_BRIDGE_PIERS[closest_pier_id]
